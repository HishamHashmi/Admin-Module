...
{
    public partial class UnblockRestaurants : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            objCmd.CommandText = "SELECT * FROM BlockedRestaurants";
        ...
        protected void ButtonDelete_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                cmd.CommandText = "INSERT into restaurantAdminAccount(restaurantAdminUsername,restaurantAdminName,restaurantAdminPassword,restaurantAdminRptPassword,restaurantAdminEmail,restaurantAdminDP) values('" + restaurantAdminUName + "','" + restaurantAdminName + "','" + restaurantAdminPass + "','" + restaurantAdminRptPass + "','" + restaurantAdminEmail + "','" + restaurantAdminDP + "')";
                cmd.ExecuteNonQuery();
                cmd.CommandText = "DELETE FROM BlockedRestaurants WHERE bluname = @customerName";
                cmd.Parameters.AddWithValue("@customerName", restaurantAdminUName);
                cmd.ExecuteNonQuery();
                sqlTran.Commit();
                con.Close();
                Response.Redirect("UnblockRestaurants.aspx");
            }
        }
    }
}